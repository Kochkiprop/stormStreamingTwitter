...
public class ParseTweetBolt extends BaseRichBolt
{
  ...
  private String[] skipWords = {"rt", "to", "me","la","on","that","que",
    "followers","watch","which","only", "should","those","when","know","not","have","like","I'm","new","good","do",
    "more","es","te","followers","Followers","las","you","and","de","my","is",
    "en","una","in","for","this","go","en","all","no","don't","up","are",
    "http","http:","https","https:","http://","https://","https://"+"t","with","just","your",
  ...
  public void execute(Tuple tuple)
  {
    ...
    //if (tweet.contains("@HomeboyzRadio")){
    ...
    //String[] tokens = tweet.toLowerCase().split(delims);
