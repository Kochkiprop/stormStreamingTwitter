...
public class TweetSpout extends BaseRichSpout
{
  ...
  private class TweetListener implements StatusListener {
    ...
    public void onStatus(Status status)
    {
      ...
      //if(containsIgnoreCase(status.getText(),"HomeboyzRadio")){
      ...
      SpoutOutputCollector    spoutOutputCollector)
  {
    ...
    tweetFilterQuery.track(new String[]{"eric","omondi","eric omondi"}); // OR on keywords
    tweetFilterQuery.locations(new double[][]{new double[]{-2.479047, 29.417962},
                new double[]{4.327582, 41.085443
    ...
    //tweetFilterQuery.locations(new double[][]{new double[]{-0.091702,34.767957},new double[]{-4.043477,39.668206},
    //            new double[]{-1.292066,36.821946
    //            }}); // See https://dev.twitter.com/docs/streaming-apis/parameters#locations for proper location doc.
                //Note that not all tweets have location metadata set.
